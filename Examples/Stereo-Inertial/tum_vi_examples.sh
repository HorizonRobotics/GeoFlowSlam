#!/bin/bash
pathDatasetTUM_VI='/root/horizon/3D_Recon/dataset/TUM-VI' #Example, it is necesary to change it by the dataset path
...
# gdb ./stereo_inertial_tum_vi
./stereo_inertial_tum_vi \
 ../../Vocabulary/ORBvoc.txt ./TUM-VI.yaml \
 /root/horizon/3D_Recon/dataset/TUM-VI/dataset-corridor4_512_16/mav0/cam0/data \
  /root/horizon/3D_Recon/dataset/TUM-VI/dataset-corridor4_512_16/mav0/cam1/data \
