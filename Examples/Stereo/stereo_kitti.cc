...
int main(int argc, char **argv)
{
    ...
    ORB_SLAM3::System SLAM(argv[1],argv[2],ORB_SLAM3::System::STEREO,true, 0, std::string(),std::string(argv[3]));
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        // 设置 CLAHE 的参数
        // clipLimit 控制对比度限制的阈值
        // tileGridSize 控制每个小网格的大小
                ...
                vector<string> &vstrImageRight, vector<double> &vTimestamps)
{
    ...
    for(int i=0; i<nTimes; i++)
    {
        ...
        std::cout <<vstrImageLeft[i] <<std::endl;
    }
}
